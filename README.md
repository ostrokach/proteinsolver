...
[![binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/git/https%3A%2F%2Fmybinder%3AhTGKLsjmxRS8xNyHxRJB%40gitlab.com%2Fostrokach%2Fproteinsolver.git/v0.1.21)
[![docs](https://img.shields.io/badge/docs-v0.1.21-blue.svg)](https://ostrokach.gitlab.io/proteinsolver/v0.1.21/)
...
[![pipeline status](https://gitlab.com/ostrokach/proteinsolver/badges/v0.1.21/pipeline.svg)](https://gitlab.com/ostrokach/proteinsolver/commits/v0.1.21/)
[![coverage report](https://gitlab.com/ostrokach/proteinsolver/badges/master/coverage.svg?job=docs)](https://ostrokach.gitlab.io/proteinsolver/v0.1.21/htmlcov/)
...
```bash
docker run -it --rm -p 8000:8000 registry.gitlab.com/ostrokach/proteinsolver:v0.1.21 jupyter notebook --ip 0.0.0.0 --port 8000
```
