...
[![binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/git/https%3A%2F%2Fmybinder%3AhTGKLsjmxRS8xNyHxRJB%40gitlab.com%2Fostrokach%2Fproteinsolver.git/v0.1.22)
[![docs](https://img.shields.io/badge/docs-v0.1.22-blue.svg)](https://ostrokach.gitlab.io/proteinsolver/v0.1.22/)
...
[![pipeline status](https://gitlab.com/ostrokach/proteinsolver/badges/v0.1.22/pipeline.svg)](https://gitlab.com/ostrokach/proteinsolver/commits/v0.1.22/)
[![coverage report](https://gitlab.com/ostrokach/proteinsolver/badges/master/coverage.svg?job=docs)](https://ostrokach.gitlab.io/proteinsolver/v0.1.22/htmlcov/)
...
```bash
docker run -it --rm -p 8000:8000 registry.gitlab.com/ostrokach/proteinsolver:v0.1.22 jupyter notebook --ip 0.0.0.0 --port 8000
```
